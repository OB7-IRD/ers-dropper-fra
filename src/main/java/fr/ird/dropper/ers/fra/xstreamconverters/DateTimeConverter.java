...
/**
 * Conversion des attributs typés xs:dateTime, leur format est celui de
 * l'iso8601 : [-]CCYY-MM-DDThh:mm:ss[Z|(+|-)hh:mm]
 *
...
public class DateTimeConverter extends AbstractSingleValueConverter {
    ...
    public Object fromString(String value) {
        DateTimeFormatter iso8601Formater = ISODateTimeFormat.dateTimeParser();
        // On essaye d'abbord de lire la date au format iso8601 ([-]CCYY-MM-DDThh:mm:ss[Z|(+|-)hh:mm])
        try {
    ...
    public String toString(Object source) {
        ...
        DateTimeFormatter iso8601Formater = ISODateTimeFormat.dateTime();
