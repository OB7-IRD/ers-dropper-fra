...
public class Log implements Serializable {
	...
	/**
	 * Retourne tous les événements de pêche, en incluant les COE et COX fils de TRZ et CRO.
	 * 
	...
	/**
	 * Retourne tous les événements de pêche, en incluant ou non les COE et COX qui ne sont pas
	 * directement sous LOG.
	 * 
	 * @param includeAllCoesAndCox si <code>true</code>, tous les COE et COX sont retournés,
	 * même ceux qui ne sont pas directement fils de LOG (c-a-d les fils COE et COX des TRZ et
	 * CRO sont inclus). Si <code>false<code>, seuls les COE et COX qui sont directement sous 
	 * LOG sont inclus.
	 * 
	 * @return the evts les événements de pêche
	 */
