...
/**
 * JFO Catch sub-declaration: Contains information about the catch and total
 * quantity caught in the JFO operation (according to BFT rules). 1.1-2.0:
 * Added.
 *
 * <p>
 * Classe Java pour Jci complex type.
 *
 * <p>
...
@XmlType(name = "JciDeclarationType", propOrder = {
    "pos",
    "spe"
})
